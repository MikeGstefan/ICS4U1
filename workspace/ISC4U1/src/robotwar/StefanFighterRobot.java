...
/** 
 * My version of the FighterRobot
 * @version 01/17/2022
 * @author Mike Stefan
*/
public class StefanFighterRobot extends FighterRobot{
    ...
    private double MOVE_DIST_SCALER = 0.196188;
    private double OPP_DIST_SCALER = 0.6;
    private double DIFF_SCALER = 5.990721;
    private double DIFF_ACCUARACY_SCALER = 17.954302;
    private double HEALTH_WEIGHT = 19.12945;
     ...
     */
	public StefanFighterRobot (City c, int a, int s, Direction d, int id, int health){
