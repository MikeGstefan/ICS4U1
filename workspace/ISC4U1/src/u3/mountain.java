...
//		int corner3 = (y3 + y2)/2 +50;
		...
		int corner2 = (y1 + y3)/2;
		int corner3 = (y3 + y2)/2;
		int off1 = rand.nextInt((int)((y1 + y2)/15))*randSgn();
		int off2 = rand.nextInt((int)((y1 + y3)/15))*randSgn();
		int off3 = rand.nextInt((int)((y3 + y2)/15))*randSgn();
		corner1 += m1;
		corner2 += m2;
		corner3 += m3;
		l--;
...
//		drawMountain(400,20,10,420,790,420,4, rand.nextInt((int)(50))*randSgn(),50,50,g);
		drawMountain(400,20,10,420,790,420,3, 0,0,0,g);
